...
public class MITRETrial4Script : DemoScript {
	...
	void Update () {
		...
		if (currentStep == ScriptStep.Step7D) {
			string obj1Name = "block2";
	...
	void Proceed(object sender, ElapsedEventArgs e) {
		...
		if (goBack) {	// try again
			...
			else if (currentStep < ScriptStep.Step8) {
				currentStep = ScriptStep.Step7A;	
			}
		}
		else {
